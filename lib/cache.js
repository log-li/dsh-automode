...
const TARGET_PATH_KEYS = ['file_path', 'path', 'dir', 'root'];
/**
 ...
 */
export function toolArgsKey(args, reason) {
    if (typeof args === 'object' && args !== null) {
        ...
        if (argsText)
            return `${String(reason ?? '')} |args:${hashString(argsText)}`;
    }
