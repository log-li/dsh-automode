...
import { classifyBand, compileRegex, bashCommandOf, isFileTool, collectPaths, looksMachineLeaving } from './bands.js';
...
import { actionSummaryOf, argsPreviewOf, previewTruncated, classifyFailureCategory, classifyTwoStage, renderTranscript, renderUserIntent, resolveRoute, restoreToolCallArgs, truncateToChars, } from './classifier.js';
 ...
 */
export const ALLOWLIST_SENTENCE = 'Auto-mode path allowlist: to trust a path the classifier rejects, add it to ' +
